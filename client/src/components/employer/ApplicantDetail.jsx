              ...
              <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col justify-center">
                ...
                <div className="flex gap-4">
                  <Button
                    ...
                    className="flex-1 bg-emerald-600 text-white border-none rounded-xl py-4 flex items-center justify-center gap-2 font-black text-xs hover:bg-emerald-700 shadow-lg shadow-emerald-500/20"
                  >
                    <CheckCircle size={16} /> DUYỆT
                  </Button>
                  <Button
                    onClick={() => onUpdateStatus(applicant.id, 'rejected')}
                    className="flex-1 bg-rose-600 text-white border-none rounded-xl py-4 flex items-center justify-center gap-2 font-black text-xs hover:bg-rose-700 shadow-lg shadow-rose-500/20"
                  >
