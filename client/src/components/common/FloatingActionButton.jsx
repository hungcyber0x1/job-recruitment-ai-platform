        ...
        <div className="relative">
          ...
          <Link to="/chat">
            ...
            >
              ...
              {/* Notification badge */}
              <span className="absolute -top-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full bg-orange-500 text-xs font-bold shadow-lg animate-pulse">
                AI
              </span>
            </button>
          </Link>
