      ...
      >
        ...
        <div className="flex justify-center">
          <div
            className={cn(
              ...
              isExpanded
                ? 'bg-white text-emerald-600 ring-2 ring-emerald-500/20'
                : 'bg-slate-50 text-slate-400 group-hover:bg-white group-hover:text-emerald-600 group-hover:shadow-md group-hover:ring-1 group-hover:ring-slate-100 ring-transparent'
            )}
          >
        ...
        <div className="flex items-center justify-end px-2" onClick={(e) => e.stopPropagation()}>
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="end"
              className="w-56 p-2 rounded-xl shadow-premium border-slate-100/60 backdrop-blur-xl bg-white/95"
            >
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h5 className="text-xs font-bold uppercase tracking-normal text-emerald-600/80">
              ...
              <div className="flex flex-wrap gap-2.5">
                {categorySkills.length > 0 ? (
                  categorySkills.map((skill) => (
                    <div
                      key={skill.id}
                      className="group/tag relative px-4 py-2 bg-white border border-slate-200/60 rounded-xl text-xs font-bold uppercase tracking-normal text-slate-600 hover:border-emerald-500 hover:text-emerald-600 hover:ring-4 hover:ring-emerald-500/5 transition-all shadow-sm hover:shadow-md"
                    >
                      {skill.name}
                      <button
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-2">
                ...
                <h5 className="text-xs font-bold uppercase tracking-normal text-slate-400">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-5 rounded-[2rem] bg-slate-50/50 border border-slate-100 shadow-inner group/card hover:bg-white transition-all duration-500">
                  <p className="text-xs font-bold text-slate-400 uppercase tracking-normal group-hover/card:text-emerald-600">
                    Độ hot ngành
                  </p>
                ...
                <div className="p-5 rounded-[2rem] bg-slate-50/50 border border-slate-100 shadow-inner group/card hover:bg-white transition-all duration-500">
                  <p className="text-xs font-bold text-slate-400 uppercase tracking-normal group-hover/card:text-blue-600">
                    Ứng viên mới
                  </p>
                  <div className="mt-2 flex items-end gap-2">
                    <p className="text-2xl font-bold text-slate-400 tabular-nums">—</p>
