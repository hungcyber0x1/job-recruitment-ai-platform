...
const AdminUserDetailsModal = ({ isOpen, onClose, user }) => {
  ...
  const getRoleBadgeVariant = (role) => {
    ...
    if (role === 'recruiter') return 'emerald';
    return 'outline';
  };
        ...
        <div className="px-8 pb-10">
          ...
          <div className="relative -mt-16 mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            ...
            <div className="flex flex-col items-end gap-3 mb-2">
              <div className="flex flex-wrap gap-2">
                <Badge
                  variant={getRoleBadgeVariant(roleValue)}
          ...
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-slate-900 mb-2 flex items-center gap-3">
              {user.full_name}
              {roleValue === 'admin' && <ShieldAlert size={20} className="text-rose-500" />}
            </h2>
              ...
              <div className="mt-8 space-y-4">
                ...
                >
                  <FileText
                    ...
                    className={cn(
                      'mb-3',
                      user.internal_notes ? 'text-amber-500' : 'text-slate-300'
                    )}
                  />
                    ...
                    <div key={idx} className="relative">
                      ...
                      <div className="bg-slate-50 border border-slate-100 rounded-xl p-4 hover:shadow-md transition-all">
                        <div className="flex items-center justify-between mb-2">
                          <Badge
                            variant="outline"
                            className="text-xs font-bold uppercase tracking-normal rounded-lg border-slate-100 bg-white shadow-sm"
                          >
                            {activity.action}
                          </Badge>
