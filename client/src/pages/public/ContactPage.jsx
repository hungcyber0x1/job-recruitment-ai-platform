        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-8 leading-[1.1] tracking-tight text-wrap-balance">
              Liên hệ với <span className="gradient-text">HireAI</span>
            </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-stretch">
              ...
              <div className="bg-slate-900 rounded-[32px] p-8 text-white">
                ...
                <div className="flex justify-center gap-6">
                  {[
                    ...
                    <button
                      key={key}
                      className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center text-white hover:bg-primary transition-all hover:-translate-y-1"
                    >
                      <Icon size={20} />
                    </button>
                  ))}
            ...
            <div className="lg:w-2/3">
              <Card className="p-10 md:p-16 h-full border-none shadow-2xl shadow-primary/10 flex flex-col">
                <div className="mb-12">
                  <h3 className="text-3xl font-black text-slate-900 mb-2">Gửi tin nhắn phản hồi</h3>
                ...
                <form className="space-y-8 flex-grow">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-6 py-4 rounded-2xl bg-slate-50 border border-slate-100 focus:outline-none focus-visible:ring-4 focus-visible:ring-primary/10 focus:border-primary transition-all font-medium text-slate-700"
                      />
                    </div>
                    <div>
                      <label className="text-sm font-black text-slate-900 uppercase tracking-widest ml-1 mb-2 block">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-6 py-4 rounded-2xl bg-slate-50 border border-slate-100 focus:outline-none focus-visible:ring-4 focus-visible:ring-primary/10 focus:border-primary transition-all font-medium text-slate-700 resize-none"
                    ></textarea>
                  </div>

                  <Button
                    variant="primary"
                    className="w-full py-5 text-xl font-black rounded-[24px] shadow-xl shadow-primary/20 group"
                  >
                    Gửi tin nhắn đi
                    <Send
                      size={20}
                ...
                <div className="mt-12 p-8 bg-primary/5 rounded-[32px] border border-primary/10 flex flex-col md:flex-row items-center gap-6 justify-between group cursor-pointer hover:bg-card transition-colors duration-200 ease-out">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-2xl bg-white shadow-xl shadow-primary/10 flex items-center justify-center text-primary">
