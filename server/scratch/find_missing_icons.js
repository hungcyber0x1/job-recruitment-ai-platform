...
function findMissingIcons(rootDir) {
  ...
  const ignored = new Set([
    'React', 'Fragment', 'Card', 'Button', 'Badge', 'Avatar', 'Input', 'Label', 'Tabs', 'Table', 'Dialog', 
    'DropdownMenu', 'Popover', 'Tooltip', 'Select', 'ScrollArea', 'Separator', 'Skeleton', 'Switch', 
    'Checkbox', 'RadioGroup', 'Slider', 'Progress', 'Calendar', 'Accordion', 'Alert', 'AspectRatio', 
    'Collapsible', 'HoverCard', 'NavigationMenu', 'Resizable', 'ScrollReveal', 'AnimatedCounter', 
    'AdminPageHeader', 'PremiumStatCard', 'ChartSurface', 'AdminTable', 'AnimatePresence', 'Link',
    'XAxis', 'YAxis', 'CartesianGrid', 'Tooltip', 'Legend', 'ResponsiveContainer', 'AreaChart', 'Area',
    'BarChart', 'Bar', 'LineChart', 'Line', 'PieChart', 'Pie', 'Cell', 'Sector', 'ComposedChart',
    'DropdownMenuContent', 'DropdownMenuItem', 'DropdownMenuTrigger', 'DropdownMenuSeparator',
    'SelectContent', 'SelectItem', 'SelectTrigger', 'SelectValue', 'CardContent', 'CardHeader', 'CardTitle'
  ]);
